...
from . import views
from app_smart.api.viewsets import CreateUserAPIViewSet, SensorViewSet, SensorFilterView, TemperaturaDataViewSet, UmidadeDataViewSet, LuminosidadeDataViewSet, ContadorDataViewSet
from rest_framework_simplejwt.views import TokenObtainPairView, TokenRefreshView
from rest_framework.routers import DefaultRouter

from app_smart.api.filters import TemperaturaFilterView, UmidadeFilterView, LuminosidadeFilterView, ContadorFilterView
